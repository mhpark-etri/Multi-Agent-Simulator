...
cp /mnt/temp2/CMakeLists_ORB_SLAM2.txt ./CMakeLists.txt
cp /mnt/temp2/CMakeLists_examples_ORB_SLAM2.txt ./Examples/ROS/ORB_SLAM2/CMakeLists.txt
#cp /mnt/temp2/CMakeLists_orb_slam2_ros.txt pyrobot/robots/LoCoBot/locobot_navigation/orb_slam2_ros/CMakeLists.txt
cp /mnt/temp2/mono_kitti.cc ./Examples/Monocular/
cp /mnt/temp2/mono_euroc.cc ./Examples/Monocular/
cp /mnt/temp2/mono_tum.cc ./Examples/Monocular/
cp /mnt/temp2/rgbd_tum.cc Examples/RGB-D/
cp /mnt/temp2/stereo_euroc.cc Examples/Stereo/
cp /mnt/temp2/stereo_kitti.cc Examples/Stereo/
chmod +x build.sh
./build.sh

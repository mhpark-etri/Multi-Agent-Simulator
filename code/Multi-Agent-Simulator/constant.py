...
CMD_HELLO_STRETCH2_ARG_MODEL_UNLESS = "<arg name=\"model\" value=\"$(find stretch_gazebo)/urdf/stretch_gazebo_standard_gripper.urdf.xacro\" unless=\"$(arg dex_wrist)\"/>"
CMD_HELLO_STRETCH2_ARG_MODEL_IF = "<arg name=\"model\" value=\"$(find stretch_gazebo)/urdf/stretch_gazebo_dex_wrist.urdf.xacro\" if=\"$(arg dex_wrist)\"/>"
CMD_HELLO_STRETCH2_NODE_DESCRIPTION = "<param name=\"robot_description\" command=\"$(find xacro)/xacro $(arg model) gpu_lidar:=$(arg gpu_lidar) visualize_lidar:=$(arg visualize_lidar)\"/>"
CMD_HELLO_STRETCH2_NODE_SPAWN_OPEN = "<node name=\"spawn_"
CMD_HELLO_STRETCH2_NODE_SPAWN_PROPERTIES_1 = "pkg=\"gazebo_ros\" type=\"spawn_model\" output=\"screen\" args=\"-urdf -model"
CMD_HELLO_STRETCH2_NODE_SPAWN_PROPERTIES_2 = "-param robot_description"
CMD_HELLO_STRETCH2_NODE_SPAWN_POSITION_X = "-x"
CMD_HELLO_STRETCH2_NODE_SPAWN_POSITION_Y = "-y"
CMD_HELLO_STRETCH2_NODE_SPAWN_POSITION_Z = "-z"
CMD_HELLO_STRETCH2_NODE_SPAWN_CLOSE = "\"/>"
CMD_HELLO_STRETCH2_NODE_STATE_PUBLISHER_OPEN = "<node pkg=\"robot_state_publisher\" type=\"robot_state_publisher\" name=\"robot_state_publisher\">"
CMD_HELLO_STRETCH2_PARAM_STATE_PUBLISHER_FREQUENCY = "<param name=\"publish_frequency\" type=\"double\" value=\"30.0\" />"
CMD_HELLO_STRETCH2_NODE_STATE_PUBLISHER_CLOSE = "</node>"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_JOINT = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/joints.yaml\" ns=\"stretch_joint_state_controller\" />"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_DRIVE_CONFIG = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/drive_config.yaml\" ns=\"stretch_diff_drive_controller\" />"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_ARM = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/arm.yaml\"/>"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_HEAD = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/head.yaml\" />"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_GRIPPER = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/gripper.yaml\" />"
CMD_HELLO_STRETCH2_ROSPARAM_PARAM_LOAD_CONFIG_DEX_WRIST = "<rosparam command=\"load\" file=\"$(find stretch_gazebo)/config/dex_wrist.yaml\" if=\"$(arg dex_wrist)\"/>"
CMD_HELLO_STRETCH2_NODE_CONTROLLER_SPAWN_UNLESS = "<node name=\"stretch_controller_spawner\" pkg=\"controller_manager\" type=\"spawner\" args=\"stretch_joint_state_controller stretch_diff_drive_controller stretch_arm_controller stretch_head_controller stretch_gripper_controller\" unless=\"$(arg dex_wrist)\"/>"
CMD_HELLO_STRETCH2_NODE_CONTROLLER_SPAWN_IF = "<node name=\"stretch_controller_spawner\" pkg=\"controller_manager\" type=\"spawner\" args=\"stretch_joint_state_controller stretch_diff_drive_controller stretch_arm_controller stretch_head_controller stretch_gripper_controller stretch_dex_wrist_controller\" if=\"$(arg dex_wrist)\"/>"
CMD_HELLO_STRETCH2_NODE_GROUND_TRUTH_ODOM = "<node name=\"publish_ground_truth_odom\" pkg=\"stretch_gazebo\" type=\"publish_ground_truth_odom.py\" output=\"screen\"/>"
...
SETTING_WORLD_OPTION_FIRE_SPAWN_PARTICLE_PATH = "World_Option_Fire_Spawn_Particle_Path"
SETTING_WORLD_OPTION_FIRE_PARTICLE_EMITTER_PATH = "World_Option_Fire_Particle_Emitter_Path"
SETTING_WORLD_OPTION_FIRE_SDF_FILE_PATH = "World_Option_Fire_SDF_File_Path"
SETTING_WORLD_OPTION_FIRE_PARTICLE_COUNT = "World_Option_Fire_Particle_Count"
SETTING_WORLD_OPTION_FIRE_GROUP_COUNT = "World_Option_Fire_Group_Count"
SETTING_WORLD_OPTION_FIRE_SPREAD_SCALE = "World_Option_Fire_Spread_Scale"